...
int main(){
  ...
  io_handler_ptr->set_callback(std::bind(&GameManager::process_data, &game_manager, std::placeholders::_1)); // user_presentation.set_calbackでsubscribeしたとき用のコールバックを設定している。setter injection
